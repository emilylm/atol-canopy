def generate_experiment_xml(submission_json: Dict[str, Any], alias: str, center_name: str = "AToL",
    ...
    library_name.text = submission_json.get("library_name", "")
    
    # Add library strategy
    library_strategy = ET.SubElement(library_descriptor, "LIBRARY_STRATEGY")
    library_strategy.text = submission_json.get("library_strategy", "OTHER")
    
    # Add library source
    library_source = ET.SubElement(library_descriptor, "LIBRARY_SOURCE")
    library_source.text = submission_json.get("library_source", "GENOMIC")
    
    # Add library selection
    library_selection = ET.SubElement(library_descriptor, "LIBRARY_SELECTION")
    library_selection.text = submission_json.get("library_selection", "unspecified")
    ...
    platform_type = submission_json.get("platform", "ILLUMINA")
    ...
    instrument_model.text = submission_json.get("instrument_model", "unspecified")
